quest = [{'titulo': 'Qual o resultado da operação 57 + 32?',
         ...
         {'titulo': 'Qual destes termos menos tem relação com o fenômeno da globalização?',
          ...
          {'titulo': 'Qual a rua do Insper?',
          'nivel': 'facil',
          'opcoes': {'A': 'Ibirapuera', 'B': 'Brigadeiro Faria Lima', 'C': 'Rua da Consolação', 'D': 'Quata'},
          'correta': 'D'},
         ...
         {'titulo': 'Dentre os listados, qual destes esportes é menos praticado no Brasil?',
          ...
          {'titulo': 'Dentre os listados, qual destes times é brasileiro?',
          'nivel': 'facil',
          'opcoes': {'A': 'Liverpool', 'B': 'São Paulo', 'C': 'Boca Juniors', 'D': 'Chelsea'},
          'correta': 'B'},
         ...
         {'titulo': 'Qual a pessoa mais seguida no Instagram?',
          ...
          {'titulo': 'Em que ano ocorreu a chegada do homem à Lua?',
          'nivel': 'medio',
          'opcoes': {'A': '1969', 'B': '1972', 'C': '1965', 'D': '1975'},
          'correta': 'A'},

          {'titulo': 'Qual é o elemento químico representado pela letra O?',
          'nivel': 'medio',
          'opcoes': {'A': 'Ouro', 'B': 'Ósmio', 'C': 'Ozônio', 'D': 'Oxigênio'},
          'correta': 'D'},
         ...
         {'titulo': 'Qual desses não é um folclore brasileiro?',
          'nivel': 'dificil',
          'opcoes': {'A': 'Saci', 'B': 'Mula sem cabeça', 'C': 'Emilia', 'D': 'Curupira'},
          'correta': 'C'},

         {'titulo': 'Qual dessas seleçoes já jogou uma copa do mundo',
          'nivel': 'dificil',
          'opcoes': {'A': 'Finlândia', 'B': 'Venezuela', 'C': 'País de Gales', 'D': 'India'},
          'correta': 'C'}
        ]